...
# Bring up cluster infrastructure - Not using only 'up' on purpose
...
# Redis and Nginx containers are brought up during vagrant provisioning as they don't need the entire infrastructure up
